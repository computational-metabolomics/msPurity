...
#'
#' @description
#' Uses a purityPD object remove peaks from either (or both) samples and
...
#' @export
setMethod(f="filterp", signature="purityPD", definition= function(Object, thr = 5000, rsd=20, sampleOnly = TRUE) {
  if(sampleOnly){
