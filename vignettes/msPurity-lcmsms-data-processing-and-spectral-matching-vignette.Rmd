...
* XCMS processing 
    +  (mzML files) -> xcms.xcmsSet  -> xcms.group -> xcms.retcor -> xcms.group -> (xcmsObj)
* XCMS processing (version >= 3)
    +  (mzML files) -> MSnBase.readMSdata -> xcms.findChromPeaks -> xcms.groupChromPeaks-> xcms.adjustRtime -> xcms.groupChromPeaks -> optionally convert to xset format using as(xcmsObj, "xcmsSet") -> (xcmsObj)
...
## XCMS (versions < 3)  processing workflow
