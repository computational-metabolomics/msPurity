...
The spectral matching is then run on all fragmentation scans collected in all files using the `spectral_matching` function. The function updates the previously generated database with
the spectral matching annotations.
