...
A database can be made of the LC-MS/MS dataset - this can then be udpated with the spectral matching data (from spectralMatching function). The full schema of the database is found xxx. This replaces the old schema used by the deprecated function spectral_matching.
